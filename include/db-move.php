...
class MoveDb extends Battle {
	...
	public static function __252() { # 下马威、In process...
		...
		if(parent::$atk[1][2][9] !== '1') return parent::FailMove();
...
return;
	...
	public static function __387() { # 最终手段
		...
		if(empty($arr) || array_diff($arr, parent::$atk[1][9])) return parent::FailMove();

	}

	public static function __389() { # 偷袭

		if(parent::$defmove['class'] === '0' || $i === 1) return parent::FailMove();
