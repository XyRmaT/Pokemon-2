...
Kit::Library('class', array('obtain', 'battle', 'pokemon'));

$mid = !empty($_GET['mid']) ? intval($_GET['mid']) : 0;

$_GET['process'] = (!empty($_GET['process']) && in_array($_GET['process'], array('usemove', 'useitem', 'swappm')) && $user['inbtl'] === '1') ? $_GET['process'] : '';
